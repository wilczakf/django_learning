...
from django_learning.settings import POSTS_PAGINATE_BY, LAST_POSTS_NUM_IN_REPLY
...
class Topic(models.Model):
    ...
    def get_last_ten_posts(self):
        return self.posts.order_by("-created_at")[:LAST_POSTS_NUM_IN_REPLY]
