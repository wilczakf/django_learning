...
class TopicPostsTests(TestCase):
    def setUp(self) -> None:
        ...
        user = User.objects.create_user(username="test_user", email="user@test.com", password="test_password")
        topic = Topic.objects.create(subject="Test topic.", board=board, starting_user=user)
